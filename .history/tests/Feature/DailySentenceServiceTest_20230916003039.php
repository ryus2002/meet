...
class DailySentenceServiceTest extends TestCase
{
     ...
     * 模擬成功的 API 響應
     */
    public function testGetSentenceSuccessFakeApi()
    {
        // 模擬成功的 API 響應
     ...
     * 模擬API傳回HTTP 500測試
     */
    public function testGetSentenceFailureFakeApi()
    {
        // 模擬失敗的 API 響應
     ...
     * 模擬API連接超時測試
     */
    public function testTimeoutHandlingFakeApi()
    {
     ...
     * 模擬API無效Url測試
     */
    public function testInvalidUrlHandlingFakeApi()
    {
